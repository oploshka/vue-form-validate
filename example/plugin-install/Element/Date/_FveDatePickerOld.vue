...
// TODO fix logic
//      Работа плагина основана на альфа версии v-calendar
//      Элемент формы работает не стабильно
//      Убран плагин v-mask (необходимо что то под vue 3)
//      Не уверен что эта версия когда либо работала!!!
//
//
...
export default {
  ...
  computed: {
    ...
    valuePrepare() {
      ...
      let date = DateTime(this.modelValue, this.settings.DATE_FORMAT_API, true);
      if( !date.isValid() ){
        // TODO: fix placeholder prepareInput
        return null;
      }
      ...
      return this.prepareInput(this.modelValue);
    },
